                ...
                <form id="form" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <select class="form-select mb-3 w-full" style="width: 100%" id="vendor" name="vendor_id" required>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <select class="form-select mb-3 selectType" aria-label="Default select example" id="type" required
                                    name="type_id">
                            </select>
                        </div>
                        <div class="col-md-6 col-sm-12">
                        ...
                        @if (auth()->user()->role != 'presence')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link genostab-custom" id="pills-single-gambar1-tab"
                                        ...
                                        role="tab" aria-controls="pills-single-gambar1" aria-selected="false">Gambar Vendor
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link genostab-custom" id="pills-single-gambar2-tab"
                                        ...
                                        role="tab" aria-controls="pills-single-gambar2" aria-selected="false">Gambar Template
                                </button>
                            </li>
                        @endif
                        <li class="nav-item" role="presentation">
                            <button class="nav-link genostab-custom" id="pills-single-gambar3-tab"
                                    ...
                                    aria-selected="false">Gambar Yousee
                            </button>
                        </li>
                    </ul>
