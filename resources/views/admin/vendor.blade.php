                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form">
                            ...
                            <span class="" style="font-size: 8pt">Password digunakan untuk login applikasi vendor</span>
                            <div id="divPassword" class="mb-3 d-flex gap-2" style="align-items: center">
                                ...
                                <span role="button" onclick="showPass(this,'password' )" class="material-symbols-outlined">visibility_off</span>
                            </div>
                            <div id="divPasswordKon" class="mb-3 d-flex gap-2" style="align-items: center">
                                <div class="form-floating flex-1" style="width: 100%">
                                    <input type="password" class="form-control formData " id="password_confirmation" name="password_confirmation"
                                           placeholder="Jhony">
                                    <label for="password" class="form-label">Ulangi Password</label>
                                </div>
                                <span role="button" onclick="showPass(this,'password_confirmation' )" class="material-symbols-outlined">visibility_off</span>
                            </div>
...
@section('morejs')
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render:function (data) {
                            return data ? '<span class="material-symbols-outlined text-success">expand_circle_down</span>'
        ...
        function toHumanDate(date) {
            ...
            let dataAnswer = dateData.add((offset * (-1)), 'm').toNow()+' ago';
