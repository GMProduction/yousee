            ...
            <div class="col-4">
                <div class="panel p-4">
                    <form id="form" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" readonly class="form-control" id="inp_tgl_req" name="inp_tgl_req"
                                   required
                        ...
                        <div class="form-floating mb-3 ">
                            <textarea style="height: auto;" type="text" class="form-control" id="name" name="name"
                                      rows="10"
...
@section('morejs')
    ...
    <script>
        ...
        function useItemEvent() {
            let data = tb_titik.rows({selected: true}).data();
