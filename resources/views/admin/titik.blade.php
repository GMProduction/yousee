    ...
    <script>
        ...
        async function getPlacesData(map) {
            try {
                ...
                let type = s_tipe;
                let pst = s_posisi;
                let response = await $.get('/cek-map/data?province=' + province + '&city=' + city + '&type=' + type +
                    '&position=' + pst);
                console.log(response)
                L.geoJSON(response.payload, {
                    pointToLayer: function(geoJsonPoint, latlng) {
                        let icon_url = geoJsonPoint['properties']['type'] !== null ? window.location
                            .origin + geoJsonPoint['properties']['type']['icon'] : '';
                    ...
                    return ('<div class="my-2"><strong>Place Name</strong> :<br>' + layer.feature.properties
                        ...
                        .properties.address + '</div><div class="my-2"><strong>Address</strong>:<br>' +
