    ...
    $("#table_id").DataTable({
      ...
      columns: [
        ...
        },
        {
          data: "latitude",
          name: "latitude",
          visible: false, // Keep this column hidden
        },
        {
          data: "longitude",
          name: "longitude",
        ...
        },
        {
          ...
          name: "isShow",
          render: function (data, x, row) {
            let show = data == 1 ? "visibility" : "visibility_off";
            let color = data == 1 ? "text-success" : "text-danger";
            return (
              '<a role="button" id="changeShow" data-id="' +
              row.id +
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            return (
              "<div class='d-flex'>" +
              "       <a class='btn-utama-soft sml rnd me-1' data-id='" +
              data +
